...
public class TestDocument6 {
    public static void main(String[] args) {
        ...
        // panggil function make dictionary
       ...
       //panggil term yang ada dan jumlah posting
        for (int i = 0; i <  index.getDictionary().size(); i++) {
            ...
            for (int j = 0; j < tempTerm.getNumberOfDocument(); j++) {
                Posting temPosting = tempTerm.getPostingList().get(j);
                Document temDocument = temPosting.getDocument();
                System.out.println("Document ke = "+temDocument.getId() );
//System.out.println(" Document ke ="+temPosting.getDocument().getId());
